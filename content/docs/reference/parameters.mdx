...
- **`fmt=svg`** is explicit only. It serves SVG origins through SVGO optimization and
  active-content stripping; raster transform modifiers do not apply to SVG output.
