...
*Re-verified August 5, 2026 against [Cloudinary pricing](https://cloudinary.com/pricing) and its [credit definition and plan comparison](https://cloudinary.com/pricing/compare-plans). Cloudinary describes plan limits as soft limits and contacts customers about upgrading after an overage; exact commercial handling can depend on the account.*

## Predictable pricing

Keenpix plans start at **$9/month for 100 GB of managed delivery**. The first 25 paying organizations receive founding prices of $9/$19/$39 with $0.08/$0.06/$0.05 per delivered GB of overage; afterward the standard catalog is $9/$29/$69 with $0.12/$0.09/$0.07 overage. Trials and complimentary grants do not claim a founding place, and claimed places never reopen after churn. Paid delivery continues while the dashboard shows usage and projected charges.
