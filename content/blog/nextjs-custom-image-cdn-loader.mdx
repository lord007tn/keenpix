...
For managed Keenpix, put the project id in the canonical delivery path. Do not use the old `keenpix.com/img/...?...project=` shape, because it adds a redirect to every generated image URL:
