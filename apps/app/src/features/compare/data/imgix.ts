...
export const imgixComparison = {
  ...
  switchReasons: [
    ...
    {
      title: 'An AGPL self-host option in v0.2.1',
      detail:
        'The published v0.2.1 release is AGPL-3.0 and includes Docker/Coolify deployment files. You can operate it in-house while owning infrastructure and routing. imgix is managed-only.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'The published v0.2.1 release is licensed AGPL-3.0 and includes Docker and Coolify deployment files. Self-hosting has no Keenpix license fee, but you operate the infrastructure.',
    },
    {
