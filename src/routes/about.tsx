    ...
    return {
      ...
      meta: [
        ...seo({
          ...
          description:
            'Keenpix is an image optimization CDN with transparent bandwidth pricing and an open-source, self-hostable engine. Meet the team and the principles behind it.',
          url: canonicalUrl,
        }),
        ...(loaderData?.selfHost
