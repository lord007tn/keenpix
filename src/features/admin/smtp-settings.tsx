    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <CardDescription>
            Configure the SMTP connection used when staff invitations are
            emailed. Env SMTP values are used when database settings are not
            enabled.
          </CardDescription>
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground text-xs">
            Delivers a sample message using the saved connection above.
          </p>
        </div>
